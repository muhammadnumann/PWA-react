...
const HeadShop = (props) => {
  ...
  const GetHeadShop = async (GetHeadShopUrl) => {
    try {
      const fetchData = await DashboardAxios.get(GetHeadShopUrl);
  ...
  const GetHeadShopUseEffect = async (GetHeadShopUrl) => {
    try {
  ...
  useEffect(() => {
    ...
    GetHeadShopUseEffect(GetHeadShopUrl);
  }, []);
  ...
  const clearFilterHandler = (e) => {
    ...
    const currentUser = localStorage.getItem("userdata");
    let data = JSON.parse(currentUser);
    let GetHeadshopUrl = `${process.env.REACT_APP_API_URI}users/getAllData/?page=${page}&category=headShop&userType=retailer&name=${searchTerm}&latlang=${data?.location?.coordinates[0]},${data?.location?.coordinates[1]}`;
    GetHeadShop(GetHeadshopUrl);
  };
        ...
        <div className="allproduct-mob d-block">
          <div className="container mx-auto">
            <div className="d-flex align-items-center justify-content-between gap-4 ps-12 pe-12">
              <h2 className="allproduct-heading">All Head Shop</h2>
              <button
                    ...
                    <div className="col-8 col-sm-12 p-0">
                      <div className="ps-sm-0 ps-3">
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-sm-3 mb-2 gap-sm-3 gap-2">
                          ...
                          <span className="d-flex gap-2 align-items-center font-18 font-weight-500 w-50">
                            <FlavorIcon />
                            <span className="cut-text">Flavour: Mint</span>
                          </span>
                        </div>
